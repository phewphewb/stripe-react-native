...
module.exports = {
  ...mockFunctions,
  ...mockHooks,
  StripeContainer: jest.fn(() => 'StripeContainer'),
  StripeProvider: jest.fn(() => 'StripeProvider'),
  CardField: jest.fn(() => 'CardField'),
  CardForm: jest.fn(() => 'CardForm'),
  ApplePayButton: jest.fn(() => 'ApplePayButton'),
  AuBECSDebitForm: jest.fn(() => 'AuBECSDebitForm'),
  GooglePayButton: jest.fn(() => 'GooglePayButton'),
  AddToWalletButton: jest.fn(() => 'AddToWalletButton'),
  PlatformPayButton: jest.fn(() => 'PlatformPayButton'),
